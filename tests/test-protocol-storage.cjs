...
test('server metadata, stable ids and task classification survive backup without local relabelling',()=>{
 const draft=fixture();
 Object.assign(draft.result,{method:'server',analysisMethod:'local_llama:gemma-4-12b-it-Q4_K_S',reportDate:'2026-09-23',reportTimezone:'Asia/Almaty'});
 ...
 assert.equal(result.method,'server');assert.equal(result.analysisMethod,'local_llama:gemma-4-12b-it-Q4_K_S');
